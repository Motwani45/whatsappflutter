...
@override
  ...
  required String gifUrl ,required MessageEnum messageEnum
    ...
    ref.read(chatControllerProvider).sendGifMessage(context: context, gifUrl: gifUrl, receiverUserId: widget.receiverUserId,);
  }
...
void sendTextMessage() async{
    ref.read(chatControllerProvider).sendTextMessage(context: context,
